...
class SummaryPrompts:
    ...
    def get_final_summary_prompt(bullets: List[str], days_covered: int) -> str:
        return f"""
        Create a fully detailed, structured technical summary from the provided bullet points, covering the past {days_covered} days. 

        Follow this outline exactly:

        ## Development Updates from the Past {days_covered} Days

        **Retain all technical information** and structure updates as follows:
        ...
        Requirements:
        1. **Include every unique technical detail**—do not summarize away critical information. 
        ...
        - Capture every unique technical aspect while avoiding redundancy.
        ...
        5. Prioritize clarity and accuracy for every technical detail.
        6. Do not create separate entries for updates within the same development effort.
